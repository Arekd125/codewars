...
int main()
{
    ...
    std::vector<std::vector<int>> e = {{1, 2, 3, 4}, {12, 13, 14, 5}, {11, 16, 15, 6}, {10, 9, 8, 7}};
    std::vector<std::vector<int>> f = {{1, 2, 3, 4, 5}, {16, 17, 18, 19, 6}, {15, 24, 25, 20, 7}, {14, 23, 22, 21, 8}, {13, 12, 11, 10, 9}};
...
std::vector<int> snail(const std::vector<std::vector<int>> &snail_map)
{
    ...
    size_t k{n - 1};
    size_t z = 0;
    // const int *wsk_s_m{&snail_map[0][0]};

    for (int i = 0; i <= 4; i++)
    {
        result.push_back(snail_map[z][i]);
    }
    z++;
    for (int i = 1; i <k; i++)
    {
